...
function SaveNewSubCategory(props) {
    ...
    const createNewSubCatRecord = (projectId, subCatName, subCatId) => {   
      ...
      if(newTaskName.current.value === undefined || newTaskName.current.value === "") {
        ...
        <summary>
            ...
            <div class="workspace-add-task-to-workarea-input">
                ...
                <form id="inputNewTask" class="workspace-add-task-input-area">
                    ...
                    <button id="previewNewTaskBtn" class="add-sub-assignment-workspace-form--add-button workspace-add-task-btn" type="button" onClick={() => createNewSubCatRecord(props.projectId, props.subCatName, props.subCatId)}>Add Task</button>
            ...
            <div class="workspace-add-task-top-workarea-view">
                ...
                {
                subCatRecordsToSave[0].Segment1 === "-" ? <div></div> :
                subCatRecordsToSave.map((task) => {
                return <details class="new-sub-grouping">
            ...
            <div class="workspace-area">
                <button id="saveWorkArea" class="workspace-add-task-btn" onClick={() => props.saveRecord(subCatRecordsToSave)}>Save Work Area</button>
            </div>
    </details>
                     );
}
